...
@interface  TPBaseWebServiceOperation()
...
@implementation TPBaseWebServiceOperation
...
- (void)startAsynchronous {
    [[TPBaseWebServiceOperation sharedQueue] addOperation:self];
}
...
- (void)performSuccess {
    ...
    NSTimeInterval ellaspedTime = [self.endTime timeIntervalSinceDate:self.startTime];
    debugLog(@"%@ completed in %f seconds", self, ellaspedTime);
